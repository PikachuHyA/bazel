...
//    ASSERT_EQ(json.encode(static_cast<double>(12345 * 12345 * 12345 * 12345 * 12345 * 12345)), "3.539537889086625e+24");
...
//    ASSERT_EQ(json.decode("3539537889086624823140625"), JsonValue(3539537889086624823140625ll));
//    ASSERT_EQ(json.decode("3539537889086624823140625.0"), JsonValue(static_cast<double>(3539537889086624823140625ll)));
